...
public class UserController {
	...
	/**
	 * 访问pdf视图 http://localhost:8086/ssmbootstrap_table/user/userpdfview.pdf
	 * @param model
	 * @return
	 */
	...
	/**
	 * 访问excel视图 http://localhost:8086/ssmbootstrap_table/user/userxlsview.xls 
	 */
	...
	/**
	 * http://localhost:8086/ssmbootstrap_table/user/userlist?order=asc&limit=10
	 * &offset=0
	 * 
	 * @param order
	 * @param limit
