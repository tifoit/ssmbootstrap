...
public class JsonpController {
	 ...
	 * "http://localhost:8086/ssmbootstrap_table/jsonp/test/1?callback=?"
	 * ,function(data){ $("body").append(data.name); console.log(data); });
	 * 
	 * 
	 * $.ajax({ type: "GET",
	 * url:"http://localhost:8086/ssmbootstrap_table/jsonp/test/1", dataType:
	 ...
	 * url:"http://localhost:8086/ssmbootstrap_table/tj/3.json",
	...
	/**
	 * http://localhost:8086/ssmbootstrap_table/jsonp/testarr?v[]=1&v[]=2&v[]=3
	 * var arr=["a","b","c"]; 前端jquery发送数组，需要traditional置为 true $.ajax({
	 * url:"http://localhost:8086/ssmbootstrap_table/jsonp/testarr",
